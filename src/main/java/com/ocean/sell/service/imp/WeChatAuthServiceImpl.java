...
public class WeChatAuthServiceImpl extends DefaultAuthServiceImpl implements WeChatAuthService {
    ...
    private static final String APP_ID = "wxf53877235a3966cc";
    private static final String APP_SECRET = "450ae31cd489f1dc76caa68bd941ae1d";
    private static final String SCOPE = "snsapi_userinfo";//  snsapi_userinfo  snsapi_base

    private String pcCallbackUrl = "http://philir.natapp1.cc/sell/wechat/pcAuth"; //pc回调域名
